...
> 한 권의 책에서 발견한 기술 인사이트, 짧지만 강력한 지식의 한 줄을 전합니다.
...
<a href="{{ site.url }}/fragments/" style="color:#888;display:inline-block;margin:0 8px;">전부</a>{% for tag in taglist %}<a href="{{ site.url }}/fragments/?tag={{ tag }}" style="color:#888;display:inline-block;margin:0 8px;">{{ tag }}</a>{% endfor %}
