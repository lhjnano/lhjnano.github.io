...
최근에는 볼륨 생성 중 간헐적으로 `EBUSY`가 뜨는 문제를 추적하다가, OpenZFS 커널 내부의 잠금 레이스까지 파고들어갔습니다. 결국 업스트림에 [PR #18611](https://github.com/openzfs/zfs/pull/18611)로 패치를 기여하게 됐는데, 버그 증상부터 잠금 계층 분석, 패치 작성, 리뷰 통과까지 꽤 긴 여정이었습니다.
