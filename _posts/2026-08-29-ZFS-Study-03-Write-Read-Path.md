...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 372"
  ...
  <defs>
    ...
    <marker id="zs3-ar-gray" markerWidth="8" markerHeight="8" refX="2" refY="4" orient="auto" markerUnits="userSpaceOnUse"><path d="M0,0 L0,6 L7,3 z" fill="#666"/></marker>
  </defs>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 568"
  ...
  <defs>
    ...
    <marker id="zs4-arm" markerWidth="8" markerHeight="8" refX="2" refY="4" orient="auto" markerUnits="userSpaceOnUse"><path d="M0,0 L0,6 L7,3 z" fill="#dc2626"/></marker>
  </defs>
