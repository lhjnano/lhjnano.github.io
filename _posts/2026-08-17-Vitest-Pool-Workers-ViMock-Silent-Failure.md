...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="13 -5.3 834 467.3"
  ...
  <defs>
    ...
    <marker id="vpw-arrow-red" markerWidth="10" markerHeight="10" refX="2" refY="4" orient="auto" markerUnits="userSpaceOnUse">
      <path d="M0,0 L0,6 L9,3 z" fill="#dc2626"/>
    </marker>
    <marker id="vpw-arrow-green" markerWidth="10" markerHeight="10" refX="2" refY="4" orient="auto" markerUnits="userSpaceOnUse">
