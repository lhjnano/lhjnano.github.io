...
<img src="/assets/images/posts/oauth2-oidc/02-oidc-adds-auth.svg" alt="OIDC는 OAuth2 위에 인증 계층을 얹는 구조" width="100%" />
...
<img src="/assets/images/posts/oauth2-oidc/03-discovery-flow.svg" alt="Discovery 문서로 모든 엔드포인트를 자동 발견하는 흐름" width="100%" />
...
<img src="/assets/images/posts/oauth2-oidc/04-sso-scenario.svg" alt="외부 앱 SSO 시나리오 전체 시퀀스" width="100%" />
