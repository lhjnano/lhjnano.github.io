...
<img src="/assets/images/posts/jwt-tokens/01-jwt-structure.svg" alt="JWT 3부분 구조: Header, Payload, Signature" width="100%" />
...
<img src="/assets/images/posts/jwt-tokens/02-auth-flow.svg" alt="JWT 인증 플로우: 로그인부터 API 호출까지" width="85%" />
...
시간 T0:       RT-1 발급
시간 T0+15m:   Access Token 만료 → RT-1로 갱신 → RT-1 폐기, RT-2 발급
시간 T0+30m:   Access Token 만료 → RT-2로 갱신 → RT-2 폐기, RT-3 발급
